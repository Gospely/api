      ...
      getAll: function*(item) {
        ...
        if (group != null && group != undefined && group != '') {
          ...
          for (var i = 0; i < privileges.length - 1; i++) {
            ...
            if (privileges[i].groups == null || privileges[i].groups ==
              undefined || privileges[i].groups == '') {
              privileges[i].open = false;
            } else {
              privileges[i].open = check(privileges[i].groups.split("_"),
                group);
            }
